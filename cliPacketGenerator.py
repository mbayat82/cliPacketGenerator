...
if __name__ == "__main__":
    ...
    os.system('cls' if os.name == 'nt' else 'clear')
    print(fg.li_blue + "Network Comman"  +fg.li_red + "D" + fg.li_yellow + "O" + fg.li_magenta + "S" + fg.li_blue + " 0.2")
