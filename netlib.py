...
#send packets, accepts packet, interface, interval, random source/dest mac, random source/dest ip flags, random source/dest ports
...
#reads keyboard keys, detects q and set stopFlag to true
def stopSend():
    global stopFlag
    stopFlag = False
    print(fg.li_yellow + "Press q to stop ..." + fg.rs)
